...
// Preserve the original local-development endpoint by default while allowing
// deployments to override it without editing source code:
// flutter run --dart-define=API_BASE_URL=https://example.com/api/
const name_domain_server = String.fromEnvironment(
  'API_BASE_URL',
