...
class AllTripage extends StatefulWidget {
  @override
  _AllTripageState createState() => _AllTripageState();
}

class _AllTripageState extends State<AllTripage> with TickerProviderStateMixin {
