...
class pusher2 extends StatefulWidget {
  // const MyApp({Key? key}) : super(key: key);

  @override
  State<pusher2> createState() => _MyAppState();
}

class _MyAppState extends State<pusher2> {
  ...
  void initState() {
    ...
    // await pusher.init(apiKey: "544d9f12b8bd2fab2009", cluster: "eu");
  ...
  void onConnectPressed() async {
    ...
    print('on eccontedt preesend function');
    // try {
    print(' In try!!!!!!!');
    try {
      pusher.init(
      ...
      pusher.subscribe(channelName: _channelName.text);
      pusher.connect();
    } catch (e) {
      log("ERROR: $e");
    }
