...
class BusProvider with ChangeNotifier {
  ...
  Future<String> addBus(
      String accessToken, String number_bus, String number_passenger) async {
    String message =
        await BusApiService().AddBus(accessToken, number_bus, number_passenger);
    notifyListeners();
    return message;
  }

  Future<void> updateBus(String token, String id, String number_bus,
      String number_passenger) async {
    try {
      final updatedBus = await BusApiService()
          .updateBus(token, number_bus, id, number_passenger);
  ...
  Future<void> deleteBus(String token, String id) async {
    try {
